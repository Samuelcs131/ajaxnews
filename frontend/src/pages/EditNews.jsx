...
const EditNews = () => {
    ...
    const [valuesInputs, setValues] = useState({titulo: 's', descricao: '', texto: '', autor: '', categoria: ''})
    ...
    // ENVIA OS DADOS PARA O BACKEND
     axios.put("http://localhost:3031/atualizar",{ titulo: valuesInputs.titulo, descricao: valuesInputs.descricao, categoria: valuesInputs.categoria, texto: valuesInputs.texto, data: dateNow,autor: valuesInputs.autor, idnoticias: valuesInputs.idnoticias})
    .then( valuesResponse => {
    ...
    <h3 className="mt-5">Editar notícia</h3>
    ...
    <div className="card mt-3 mb-5">
        ...
        <div className="card-footer">
            ...
            <button className="btn btn-primary" onClick={()=>handleSubmit()}>Atualizar</button>
        </div>
    </div>
